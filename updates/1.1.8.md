...
1. Fixed an issue when creating successfully a note (a writing note not with url), the note window would not close on success.


## Modified Files:
- client/tp-client_nui.lua
- server/tp-server_main.lua
- html/js/script_create_note.js
- fxmanifest.lua
